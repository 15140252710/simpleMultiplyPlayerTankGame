...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	[GeneratedRPCVariableNames("{\"types\":[[\"serverMessage\"]]")]
	public abstract partial class GameLogicBehavior : NetworkBehavior
	{
		public const byte RPC_SEND_SERVER_MESSAGE_SYNC = 0 + 5;
		...
		public override void Initialize(NetworkObject obj)
		{
			...
			networkObject.RegisterRpc("SendServerMessageSync", SendServerMessageSync, typeof(string));
		...
		/// </summary>
		public abstract void SendServerMessageSync(RpcArgs args);
